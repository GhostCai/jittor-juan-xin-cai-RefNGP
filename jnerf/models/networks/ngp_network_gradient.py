        ...
        # print(y.shape)
          ...
          #  print(gradients.shape)
           # print(gradients)
            ...
            gradient_norm = jt.sqrt((gradients * gradients).sum(-1)).reshape(-1,1)
            gradients = gradients / (gradient_norm + 1e-5)
           # print(gradients.shape)
            #print(x.shape)
        return -gradients.reshape(-1,64,3)
